...
<!-- generated with COPASI 4.44 (Build 295) (http://www.copasi.org) at 2025-04-08T05:51:20Z -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products.
    ...
    <Function key="Function_43" name="Rate Law for Lung_capilary_diffusion" type="UserDefined" reversible="unspecified">
      <Expression>
        D1 * (PO2_alv - PO2_cap)
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_290" name="D1" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_293" name="PO2_alv" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_288" name="PO2_cap" order="2" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    ...
    <ListOfCompartments>
      ...
      <Compartment key="Compartment_2" name="Lung alveolus" simulationType="fixed" dimensionality="3" addNoise="false">
      </Compartment>
    </ListOfCompartments>
    <ListOfMetabolites>
      ...
      <Metabolite key="Metabolite_5" name="O2" simulationType="reactions" compartment="Compartment_0" addNoise="false">
      </Metabolite>
      <Metabolite key="Metabolite_8" name="O2" simulationType="reactions" compartment="Compartment_2" addNoise="false">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
      <ModelValue key="ModelValue_0" name="Relative_Saturation_calculate" simulationType="assignment" addNoise="false">
        <Expression>
          (&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO2],Reference=Concentration>+2*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO22],Reference=Concentration>+3*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO23],Reference=Concentration>+4*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO24],Reference=Concentration>)/(4*(&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[Hb],Reference=Concentration>+&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO2],Reference=Concentration>+&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO22],Reference=Concentration>+&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO23],Reference=Concentration>+&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO24],Reference=Concentration>))
        </Expression>
        <Unit>
          1
        </Unit>
      ...
      <ModelValue key="ModelValue_1" name="Relative_Saturation_hill_KA" simulationType="assignment" addNoise="false">
        <Expression>
          (&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>/&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[KA_hemoglobin_oxygen],Reference=InitialValue>)^&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[Hill_nH],Reference=InitialValue>/(1+(&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>/&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[KA_hemoglobin_oxygen],Reference=InitialValue>)^&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[Hill_nH],Reference=InitialValue>)
        </Expression>
        <Unit>
          1
        </Unit>
...
<rdf:Description rdf:about="#ModelValue_2">
      ...
      <ModelValue key="ModelValue_7" name="PO2_capillary" simulationType="assignment" addNoise="false">
        <Expression>
          &lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=Concentration>/&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[alpha],Reference=InitialValue>
        </Expression>
        <Unit>
          mmHg
        </Unit>
...
<rdf:Description rdf:about="#ModelValue_10">
      ...
      <ModelValue key="ModelValue_12" name="Saturation_O2_abcd" simulationType="assignment" addNoise="false">
        <Expression>
          1/4*(&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[a],Reference=InitialValue>*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>+2*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[b],Reference=InitialValue>*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>^2+3*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[c],Reference=InitialValue>*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>^3+4*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[d],Reference=InitialValue>*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>^4)/(1+&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[a],Reference=InitialValue>*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>+&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[b],Reference=InitialValue>*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>^2+&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[c],Reference=InitialValue>*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>^3+&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[d],Reference=InitialValue>*&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration>^4)
        </Expression>
      </ModelValue>
      <ModelValue key="ModelValue_15" name="PO2_lung" simulationType="assignment" addNoise="false">
        <Expression>
          &lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Lung alveolus],Vector=Metabolites[O2],Reference=Concentration>/&lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[alpha],Reference=InitialValue>
        </Expression>
        <Unit>
          mmHg
        </Unit>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="R1" reversible="true" fast="false" addNoise="false">
        ...
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary]">
...
<rdf:Description rdf:about="#Reaction_2">
      ...
      <Reaction key="Reaction_7" name="Lung_capilary_diffusion" reversible="false" fast="false" addNoise="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_205" name="D1" value="2"/>
          <Constant key="Parameter_203" name="PO2_alv" value="0.1"/>
          <Constant key="Parameter_201" name="PO2_cap" value="0.1"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary]" value="0.01" type="Compartment" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Lung alveolus]" value="0.5" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[Hb]" value="1.3850923748000018e+19" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO2]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO22]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO23]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO24]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2]" value="2.4088563039999974e+17" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Lung alveolus],Vector=Metabolites[O2]" value="5.8715872409999999e+19" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[Relative_Saturation_hill_KA]" value="0.51535613538141234" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[Relative_Saturation_hill_Kd]" value="0.51535613538141234" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary]" value="30.769230769230735" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[Saturation_O2_abcd]" value="0.59015553482212024" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_lung]" value="150" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Reactions[Lung_capilary_diffusion]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Reactions[Lung_capilary_diffusion],ParameterGroup=Parameters,Parameter=D1" value="2" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Reactions[Lung_capilary_diffusion],ParameterGroup=Parameters,Parameter=PO2_alv" value="150" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_lung],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Reactions[Lung_capilary_diffusion],ParameterGroup=Parameters,Parameter=PO2_cap" value="30.769230769230735" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
        </ModelParameterGroup>
...
<rdf:Description rdf:about="#ModelParameterSet_3">
        ...
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary]" value="9.9999999999999998e-13" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[Hb]" value="1385092374.8" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO2]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO22]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO23]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO24]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2]" value="21137714.067600001" type="Species" simulationType="assignment"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[Relative_Saturation_calculate]" value="0" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[alpha]" value="1.3" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary]" value="27" type="ModelValue" simulationType="fixed"/>
...
<rdf:Description rdf:about="#ModelParameterSet_4">
    ...
    <InitialState type="initialState">
      0 2.4088563039999974e+17 0 0 0 5.8715872409999999e+19 1.3850923748000018e+19 0 0 0.51535613538141234 19901.107469078357 0.51535613538141234 30.769230769230735 0.0133563 0.00030349921178999997 5.0604851575441013e-06 7.2807224155650007e-07 0.59015553482212024 150 0.01 0.5 2.7000000000000002 39.100000000000001 1.3 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="180"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=InitialValue"/>
            <Parameter name="Minimum" type="float" value="0"/>
            <Parameter name="Maximum" type="float" value="180"/>
            <Parameter name="log" type="bool" value="0"/>
            <Parameter name="Values" type="string" value="60,100"/>
          ...
          <ParameterGroup name="Experiment">
            ...
            <ParameterGroup name="Object Map">
              <ParameterGroup name="0">
                ...
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=InitialValue"/>
              </ParameterGroup>
  ...
  <ListOfPlots>
    <PlotSpecification name="Saturation_Hb_O2" type="Plot2D" active="0" taskTypes="">
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[Relative_Saturation_hill_KA]|[O2]_0" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=InitialConcentration"/>
    ...
    <PlotSpecification name="Scan of Concentrations, Volumes, and Global Quantity Values 1" type="Plot2D" active="0" taskTypes="Scan">
      ...
      <ListOfPlotItems>
        <PlotItem name="[Hb]" type="Curve2D">
          ...
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[Hb],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[HbO2]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO2],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[HbO22]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO22],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[HbO23]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO23],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[HbO24]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[HbO24],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[O2]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Compartments[Capillary],Vector=Metabolites[O2],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
    ...
    <PlotSpecification name="SO2_species_caculate" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <Parameter name="x axis" type="string" value=""/>
      <Parameter name="y axis" type="string" value=""/>
    ...
    <PlotSpecification name="O2_transport_curve" type="Plot2D" active="1" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <Parameter name="x axis" type="string" value=""/>
      <Parameter name="y axis" type="string" value=""/>
      ...
      <Parameter name="plot engine" type="string" value="QWT"/>
      <ListOfPlotItems>
        <PlotItem name="Values[PO2_lung]|Time" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_lung],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[PO2_capillary]|Time" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Line subtype" type="unsignedInteger" value="0"/>
          <Parameter name="Line width" type="unsignedFloat" value="1.2"/>
          <Parameter name="Symbol subtype" type="unsignedInteger" value="0"/>
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Oxygen Binding to Hemoglobin,Vector=Values[PO2_capillary],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="O2_transport_curve_species" type="Plot2D" active="1" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <Parameter name="x axis" type="string" value=""/>
      <Parameter name="y axis" type="string" value=""/>
